...
Red-winged Blackbirds were among the first to return in February — their early arrival closely follows the first upward spikes in temperature.

![Red-winged Blackbird perched on reeds](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Agelaius_phoeniceus_-Ottawa%2C_Canada-8.jpg/800px-Agelaius_phoeniceus_-Ottawa%2C_Canada-8.jpg)  
*Photo by D. Gordon E. Robertson, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/)*

---

### Groundhog vs. Temperature
...
Groundhog observations lagged behind the birds, rising notably in late March and April — showing their emergence is linked to **sustained warming**.

![Groundhog in grass](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Groundhog2.jpg/800px-Groundhog2.jpg)  
*Photo by Cephas, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/)*

---

### American Robin vs. Temperature
...
Robins returned in waves starting in March, corresponding with warming trends and likely linked to increasing insect availability.

![American Robin on grass](https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Turdus_migratorius_2.jpg/800px-Turdus_migratorius_2.jpg)  
...
- Blackbirds arriving first
- Robins peaking in mid-spring
- Groundhogs increasing steadily into late spring

Together, they illustrate a **staggered biological response** to changing conditions.

---

## Interpretation and Context

This work falls within **phenology**, the study of how life cycles are timed with seasons. While climate change accelerates and shifts these cycles, local data can still reveal rich seasonal patterns. These species serve as accessible indicators for city dwellers to watch — grounded in science but visible without instruments.

Rather than relying solely on folklore (sorry, Phil), this project shows:
- **Birds respond to early warmth**
- **Groundhogs emerge once consistent warming arrives**
- **Wildlife patterns track real environmental cues**

## Conclusion

This project frames everyday animals as **phenological clues** — like stopwatches tuned to temperature. By tracking their appearances alongside weather data, we gain both insight and wonder: the changing seasons are written into the lives of our neighbors, feathered and furred.
